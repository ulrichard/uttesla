...
RUN git clone https://github.com/ulrichard/teslatte.git . \
 && git checkout feature/test_external
...
RUN cargo update -p time@0.3.28 --precise 0.3.23 || true \
 ...
 && cargo update -p clap@4.4.6 --precise  4.3.24 || true \
 && cargo update -p clap_lex@0.5.1 --precise  0.5.0 || true \
 && cargo update -p anstyle@1.0.4 --precise  1.0.2 || true \
 && cargo update -p anstyle-parse@0.2.2 --precise 0.2.1 || true
